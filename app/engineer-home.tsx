...
export default function WorkerHome() {
  ...
  const fetchNearbyEngineers = async (loc?: { latitude: number; longitude: number }, isRefresh = false) => {
    ...
    try {
      ...
      const response = await api.get(`/engineer/nearby?lat=${latitude}&lon=${longitude}`);
  ...
  // Fast refresh: only fetch API using last known location
